...
public class AudioController : MonoBehaviour
{
    ...
    {
        _instance.audioSourceSound.pitch = Random.Range(1f - sound.pitchVariationRange, 1f + sound.pitchVariationRange);
    ...
    private static IEnumerator StartFade(Music targetMusic, float duration)
    {
        ...
        int lastBeat = Mathf.FloorToInt(_instance._audioSourceMusicCurrent.timeSamples /
                                        (_instance._audioSourceMusicCurrent.clip.frequency * beatLenght));

        while (Mathf.FloorToInt(_instance._audioSourceMusicCurrent.timeSamples /
                                (_instance._audioSourceMusicCurrent.clip.frequency * beatLenght)) == lastBeat)
        {
            yield return null;
        }
        ...
        (_instance._audioSourceMusicCurrent, _instance._audioSourceMusicUnused) = (_instance._audioSourceMusicUnused,
            _instance._audioSourceMusicCurrent);
